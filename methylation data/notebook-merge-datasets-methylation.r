setwd("E:/survival/000000DrIsabelle_clinical/Expression_Clinical")
...
tableGenes <- read.table("BRCA.meth.by_mean.data.txt", sep="\t", 
...
tableClinGen <- merge(x=tableClin, y=tableGenesT, by.x="Sample.ID", by.y="Hybridization_REF")
...
write.table(data14, "BRCAMergedWAVE_methylation.csv", sep=",", row.names=FALSE, col.names=FALSE)
